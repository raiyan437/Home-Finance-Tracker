...
export const CategoryChart: React.FC<CategoryChartProps> = ({ expenses }) => {
  ...
  return (
    <div className="grid-summary" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '24px' }}>
      ...
      {/* Housemate Contribution Split Card */}
      <div className="glass-card">
        <div style={{ marginBottom: '18px' }}>
          <h3 style={{ fontSize: '1.1rem', fontWeight: 800, letterSpacing: '-0.02em' }}>Payer Contribution Split</h3>
          <p style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Proportion of total expenses paid out-of-pocket</p>
        </div>
