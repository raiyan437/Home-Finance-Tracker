...
- Evidence: Production-shaped schema/identity audits; emulator regressions separating wallet failure from successful household ledger authorization; 60 frontend tests, 19 Rules tests, 10 backend tests, type-check, lint, build, and browser preview.
